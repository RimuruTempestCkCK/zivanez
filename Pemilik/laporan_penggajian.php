...
// Count
$cntStmt = $conn->prepare("SELECT COUNT(*) total FROM penggajian $where");
...
// ── Grand Total gaji ──────────────────────────────────────
$totStmt = $conn->prepare("SELECT SUM(total_gaji) as grand_total FROM penggajian $where");
...
// ── URL builder ───────────────────────────────────────────
function buildUrl($p, $nama='', $bulan='', $tahun='', $status='') {
    $url = "?page=$p";
        ...
        <div class="flex-1 p-5 md:p-8 overflow-y-auto">
            ...
            <div class="bg-white rounded-2xl border border-border p-6 mb-6 no-print">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div class="flex items-end gap-2 md:col-span-5">
                        ...
                        <a href="laporan_penggajian.php" class="h-12 px-4 bg-muted hover:bg-secondary/10 text-secondary rounded-xl font-semibold flex items-center justify-center transition-all">
            ...
            <div class="print-header mb-4 pb-3 border-b-2 border-gray-800 text-center">
                ...
                <p style="font-size:8.5pt;color:#555;margin:2px 0;">
                    ...
                    if ($filterNama)   $parts[] = 'Pencarian: ' . htmlspecialchars($filterNama);
            ...
            <div class="bg-white rounded-2xl border border-border overflow-hidden mb-8">
                <div class="overflow-x-auto scrollbar-hide">
                    <table class="w-full min-w-[1100px]" id="penggajianTable">
                        <thead>
                        ...
                        <tfoot>
                            <tr class="bg-muted/60 border-t-2 border-primary">
                                <td colspan="6" class="px-5 py-4 text-right font-bold text-foreground uppercase text-sm">Grand Total Gaji:</td>
                                <td class="px-5 py-4 text-right">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between px-5 py-4 border-t border-border gap-3 no-print">
                    ...
                    <div class="flex items-center gap-2">
                        <?php if ($page > 1): ?>
                            <a href="<?= buildUrl($page-1, $filterNama, $filterBulan, $filterTahun, $filterStatus) ?>"
                        ...
                        <?php for ($i = max(1, $page - 2); $i <= min($totalPages, $page + 2); $i++):
                            $isActive = $i === $page;
                        ?>
                            <a href="<?= buildUrl($i, $filterNama, $filterBulan, $filterTahun, $filterStatus) ?>"
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end;">
                    <div>
                        ...
                        <p style="margin-top:4px;">
                            Status: Sudah Dibayar = lunas &nbsp;|&nbsp; Menunggu = proses &nbsp;|&nbsp; Belum Dibayar = belum diproses
                        </p>
                    </div>
