    ...
    <div class="sticky top-0 z-30 flex items-center justify-between w-full h-[90px] shrink-0 border-b border-border bg-white/80 backdrop-blur-md px-5 md:px-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="hidden sm:block text-sm text-secondary">Selamat datang, Admin Pusat — <?= date('d M Y') ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
            ...
            <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-border">
                ...
                <div>
                    ...
                    <p class="text-xs text-secondary">perlu diverifikasi</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-border overflow-hidden">
                <div class="px-5 py-4 border-b border-border flex items-center justify-between">
                    ...
                    <a href="validasi_setoran.php" class="text-xs font-semibold text-primary hover:underline">Lihat Semua</a>
                </div>
                <div class="overflow-x-auto scrollbar-hide">
                    <table class="w-full min-w-[400px]">
                        <thead>
