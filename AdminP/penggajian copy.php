...
<head>
    ...
    <meta name="description" content="Kelola data penggajian karyawan Sanjai Zivanes.">
...
<body class="font-sans bg-white min-h-screen overflow-x-hidden text-foreground">
    ...
    <main class="flex-1 lg:ml-[280px] flex flex-col min-h-screen overflow-x-hidden relative">
        <!-- Top Header Bar -->
        <div
            class="sticky top-0 z-30 flex items-center justify-between w-full h-[90px] shrink-0 border-b border-border bg-white/80 backdrop-blur-md px-5 md:px-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-bold text-2xl text-foreground">Kelola Penggajian</h2>
                    <p class="hidden sm:block text-sm text-secondary">Manajemen data gaji karyawan</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-border">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-foreground">25</p>
                ...
                <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-border">
                    ...
                    <div>
                        <p class="text-sm font-medium text-secondary">Total Gaji Bulan Ini</p>
                        <p class="text-2xl font-bold text-foreground">Rp 45.000.000</p>
                ...
                <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-border">
                    ...
                    <div>
                        <p class="text-sm font-medium text-secondary">Sudah Dibayar</p>
                        <p class="text-2xl font-bold text-foreground">20 Orang</p>
                ...
                <div
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col pt-1">
                                <h3 class="font-bold text-foreground text-lg leading-tight">Alip Gacor</h3>
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold w-fit mt-1.5">
                    ...
                    <div class="grid grid-cols-2 gap-3 py-4 border-y border-dashed border-border">
                        <div class="flex flex-col gap-1">
                            <p class="text-xs font-medium text-secondary uppercase tracking-wide">Gaji Pokok</p>
                            <p class="font-semibold text-foreground font-mono text-sm">Rp 2.500.000</p>
    ...
    <div id="add-modal"
        ...
        <div class="bg-white rounded-3xl w-full max-w-lg shadow-2xl scale-100 transition-transform duration-300">
            <div class="flex items-center justify-between p-6 border-b border-border">
                <h3 class="font-bold text-xl text-foreground">Tambah Data Gaji</h3>
